...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    {
        protected BoundEqualsValue(BoundKind kind, CSharpSyntaxNode syntax, BoundExpression value, bool hasErrors = false)
            : base(kind, syntax, hasErrors)
        {
    ...
    {
        public BoundFieldEqualsValue(CSharpSyntaxNode syntax, FieldSymbol field, BoundExpression value, bool hasErrors = false)
    ...
    {
        public BoundPropertyEqualsValue(CSharpSyntaxNode syntax, PropertySymbol property, BoundExpression value, bool hasErrors = false)
    ...
    {
        public BoundParameterEqualsValue(CSharpSyntaxNode syntax, ParameterSymbol parameter, BoundExpression value, bool hasErrors = false)
    ...
    internal sealed partial class BoundConversion : BoundExpression
    {
        ...
        public Boolean IsExtensionMethod { get; }

        public Boolean IsArrayIndex { get; }
    ...
    {
        public BoundStateMachineScope(CSharpSyntaxNode syntax, ImmutableArray<StateMachineFieldSymbol> fields, BoundStatement statement, bool hasErrors = false)
    ...
    {
        public BoundSwitchStatement(CSharpSyntaxNode syntax, BoundStatement loweredPreambleOpt, BoundExpression boundExpression, LabelSymbol constantTargetOpt, ImmutableArray<LocalSymbol> innerLocals, ImmutableArray<BoundSwitchSection> switchSections, GeneratedLabelSymbol breakLabel, MethodSymbol stringEquality, bool hasErrors = false)
            : base(BoundKind.SwitchStatement, syntax, hasErrors || loweredPreambleOpt.HasErrors() || boundExpression.HasErrors() || switchSections.HasErrors())
        {
        ...
        public BoundSwitchStatement Update(BoundStatement loweredPreambleOpt, BoundExpression boundExpression, LabelSymbol constantTargetOpt, ImmutableArray<LocalSymbol> innerLocals, ImmutableArray<BoundSwitchSection> switchSections, GeneratedLabelSymbol breakLabel, MethodSymbol stringEquality)
        {
            if (loweredPreambleOpt != this.LoweredPreambleOpt || boundExpression != this.BoundExpression || constantTargetOpt != this.ConstantTargetOpt || innerLocals != this.InnerLocals || switchSections != this.SwitchSections || breakLabel != this.BreakLabel || stringEquality != this.StringEquality)
            {
                var result = new BoundSwitchStatement(this.Syntax, loweredPreambleOpt, boundExpression, constantTargetOpt, innerLocals, switchSections, breakLabel, stringEquality, this.HasErrors);
                result.WasCompilerGenerated = this.WasCompilerGenerated;
                return result;
            }
            return this;
    ...
    internal sealed partial class BoundSwitchSection : BoundStatementList
    {
        ...
        public ImmutableArray<BoundSwitchLabel> BoundSwitchLabels { get; }
    ...
    {
        public BoundCatchBlock(CSharpSyntaxNode syntax, LocalSymbol localOpt, BoundExpression exceptionSourceOpt, TypeSymbol exceptionTypeOpt, BoundExpression exceptionFilterOpt, BoundBlock body, bool isSynthesizedAsyncCatchAll, bool hasErrors = false)
        ...
        {
            if (localOpt != this.LocalOpt || exceptionSourceOpt != this.ExceptionSourceOpt || exceptionTypeOpt != this.ExceptionTypeOpt || exceptionFilterOpt != this.ExceptionFilterOpt || body != this.Body || isSynthesizedAsyncCatchAll != this.IsSynthesizedAsyncCatchAll)
            {
                var result = new BoundCatchBlock(this.Syntax, localOpt, exceptionSourceOpt, exceptionTypeOpt, exceptionFilterOpt, body, isSynthesizedAsyncCatchAll, this.HasErrors);
                result.WasCompilerGenerated = this.WasCompilerGenerated;
                return result;
            }
            return this;
    ...
    {
        public BoundLoweredConditionalAccess(CSharpSyntaxNode syntax, BoundExpression receiver, MethodSymbol hasValueMethodOpt, BoundExpression whenNotNull, BoundExpression whenNullOpt, int id, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundComplexConditionalReceiver(CSharpSyntaxNode syntax, BoundExpression valueTypeReceiver, BoundExpression referenceTypeReceiver, TypeSymbol type, bool hasErrors = false)
    ...
    internal abstract partial class BoundTreeRewriter : BoundTreeVisitor
    {
        ...
        public override BoundNode VisitSwitchStatement(BoundSwitchStatement node)
        {
            ...
            return node.Update(loweredPreambleOpt, boundExpression, node.ConstantTargetOpt, node.InnerLocals, switchSections, node.BreakLabel, node.StringEquality);
        }
        public override BoundNode VisitSwitchSection(BoundSwitchSection node)
        {
        ...
        public override BoundNode VisitCatchBlock(BoundCatchBlock node)
        {
            ...
            return node.Update(node.LocalOpt, exceptionSourceOpt, exceptionTypeOpt, exceptionFilterOpt, body, node.IsSynthesizedAsyncCatchAll);
        }
        public override BoundNode VisitLiteral(BoundLiteral node)
        {
            TypeSymbol type = this.VisitType(node.Type);
