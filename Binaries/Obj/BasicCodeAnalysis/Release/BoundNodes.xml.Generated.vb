...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Friend MustInherit Partial Class BoundExpression
        ...
        Protected Sub New(kind As BoundKind, syntax as VisualBasicSyntaxNode, type As TypeSymbol, hasErrors As Boolean)
            MyBase.New(kind, syntax, hasErrors)
            Me._Type = type
        End Sub

        Protected Sub New(kind As BoundKind, syntax as VisualBasicSyntaxNode, type As TypeSymbol)
    ...
    Friend NotInheritable Partial Class BoundTypeArguments
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, arguments As ImmutableArray(Of TypeSymbol), hasErrors As Boolean)
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, arguments As ImmutableArray(Of TypeSymbol))
    ...
    Friend NotInheritable Partial Class BoundOmittedArgument
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, type As TypeSymbol, hasErrors As Boolean)
            MyBase.New(BoundKind.OmittedArgument, syntax, type, hasErrors)
        End Sub

        Public Sub New(syntax As VisualBasicSyntaxNode, type As TypeSymbol)
    ...
    Friend NotInheritable Partial Class BoundLValueToRValueWrapper
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, underlyingLValue As BoundExpression, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundDup
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, isReference As Boolean, type As TypeSymbol, hasErrors As Boolean)
            MyBase.New(BoundKind.Dup, syntax, type, hasErrors)
            Me._IsReference = isReference
        End Sub

        Public Sub New(syntax As VisualBasicSyntaxNode, isReference As Boolean, type As TypeSymbol)
    ...
    Friend NotInheritable Partial Class BoundBadExpression
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, resultKind As LookupResultKind, symbols As ImmutableArray(Of Symbol), childBoundNodes As ImmutableArray(Of BoundNode), type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundBadStatement
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, childBoundNodes As ImmutableArray(Of BoundNode), Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundBadVariable
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, expression As BoundExpression, isLValue As Boolean, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundArrayAccess
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, expression As BoundExpression, indices As ImmutableArray(Of BoundExpression), isLValue As Boolean, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundGetType
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, sourceType As BoundTypeExpression, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundFieldInfo
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, field As FieldSymbol, type As TypeSymbol, hasErrors As Boolean)
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, field As FieldSymbol, type As TypeSymbol)
    ...
    Friend NotInheritable Partial Class BoundMethodInfo
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, method As MethodSymbol, type As TypeSymbol, hasErrors As Boolean)
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, method As MethodSymbol, type As TypeSymbol)
    ...
    Friend NotInheritable Partial Class BoundTypeExpression
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, unevaluatedReceiverOpt As BoundExpression, aliasOpt As AliasSymbol, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundTypeOrValueExpression
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, data As BoundTypeOrValueData, type As TypeSymbol, hasErrors As Boolean)
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, data As BoundTypeOrValueData, type As TypeSymbol)
    ...
    Friend NotInheritable Partial Class BoundNamespaceExpression
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, unevaluatedReceiverOpt As BoundExpression, aliasOpt As AliasSymbol, namespaceSymbol As NamespaceSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundUnaryOperator
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, operatorKind As UnaryOperatorKind, operand As BoundExpression, checked As Boolean, constantValueOpt As ConstantValue, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundUserDefinedUnaryOperator
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, operatorKind As UnaryOperatorKind, underlyingExpression As BoundExpression, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundNullableIsTrueOperator
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, operand As BoundExpression, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundBinaryOperator
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, operatorKind As BinaryOperatorKind, left As BoundExpression, right As BoundExpression, checked As Boolean, constantValueOpt As ConstantValue, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundUserDefinedBinaryOperator
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, operatorKind As BinaryOperatorKind, underlyingExpression As BoundExpression, checked As Boolean, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundUserDefinedShortCircuitingOperator
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, leftOperand As BoundExpression, leftOperandPlaceholder As BoundRValuePlaceholder, leftTest As BoundExpression, bitwiseOperator As BoundUserDefinedBinaryOperator, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundAssignmentOperator
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, left As BoundExpression, leftOnTheRightOpt As BoundCompoundAssignmentTargetPlaceholder, right As BoundExpression, suppressObjectClone As Boolean, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundReferenceAssignment
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, byRefLocal As BoundLocal, lValue As BoundExpression, isLValue As Boolean, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundAddressOfOperator
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, binder As Binder, methodGroup As BoundMethodGroup, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundTernaryConditionalExpression
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, condition As BoundExpression, whenTrue As BoundExpression, whenFalse As BoundExpression, constantValueOpt As ConstantValue, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundBinaryConditionalExpression
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, testExpression As BoundExpression, convertedTestExpression As BoundExpression, testExpressionPlaceholder As BoundRValuePlaceholder, elseExpression As BoundExpression, constantValueOpt As ConstantValue, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundUserDefinedConversion
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, underlyingExpression As BoundExpression, inOutConversionFlags As Byte, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundDirectCast
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, operand As BoundExpression, conversionKind As ConversionKind, suppressVirtualCalls As Boolean, constantValueOpt As ConstantValue, relaxationLambdaOpt As BoundLambda, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundTryCast
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, operand As BoundExpression, conversionKind As ConversionKind, constantValueOpt As ConstantValue, relaxationLambdaOpt As BoundLambda, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundTypeOf
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, operand As BoundExpression, isTypeOfIsNotExpression As Boolean, targetType As TypeSymbol, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend MustInherit Partial Class BoundStatement
        ...
        Protected Sub New(kind As BoundKind, syntax as VisualBasicSyntaxNode, hasErrors As Boolean)
            MyBase.New(kind, syntax, hasErrors)
        End Sub

        Protected Sub New(kind As BoundKind, syntax as VisualBasicSyntaxNode)
            MyBase.New(kind, syntax)
        End Sub
    ...
    Friend NotInheritable Partial Class BoundSequencePoint
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, statementOpt As BoundStatement, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundSequencePointWithSpan
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, statementOpt As BoundStatement, span As TextSpan, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundNoOpStatement
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, flavor As NoOpStatementFlavor, hasErrors As Boolean)
            MyBase.New(BoundKind.NoOpStatement, syntax, hasErrors)
            Me._Flavor = flavor
        End Sub

        Public Sub New(syntax As VisualBasicSyntaxNode, flavor As NoOpStatementFlavor)
    ...
    Friend MustInherit Partial Class BoundMethodOrPropertyGroup
        ...
        Protected Sub New(kind As BoundKind, syntax as VisualBasicSyntaxNode, receiverOpt As BoundExpression, qualificationKind As QualificationKind, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundPropertyGroup
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, properties As ImmutableArray(Of PropertySymbol), resultKind As LookupResultKind, receiverOpt As BoundExpression, qualificationKind As QualificationKind, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundReturnStatement
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, expressionOpt As BoundExpression, functionLocalOpt As LocalSymbol, exitLabelOpt As LabelSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundYieldStatement
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, expression As BoundExpression, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundThrowStatement
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, expressionOpt As BoundExpression, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundRedimStatement
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, clauses As ImmutableArray(Of BoundRedimClause), Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundRedimClause
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, operand As BoundExpression, indices As ImmutableArray(Of BoundExpression), arrayTypeOpt As ArrayTypeSymbol, preserve As Boolean, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundEraseStatement
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, clauses As ImmutableArray(Of BoundAssignmentOperator), Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundCall
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, method As MethodSymbol, methodGroupOpt As BoundMethodGroup, receiverOpt As BoundExpression, arguments As ImmutableArray(Of BoundExpression), constantValueOpt As ConstantValue, suppressObjectClone As Boolean, type As TypeSymbol, Optional hasErrors As Boolean = False)
        ...
        Public Function Update(method As MethodSymbol, methodGroupOpt As BoundMethodGroup, receiverOpt As BoundExpression, arguments As ImmutableArray(Of BoundExpression), constantValueOpt As ConstantValue, suppressObjectClone As Boolean, type As TypeSymbol) As BoundCall
    ...
    Friend NotInheritable Partial Class BoundAttribute
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, constructor As MethodSymbol, constructorArguments As ImmutableArray(Of BoundExpression), namedArguments As ImmutableArray(Of BoundExpression), resultKind As LookupResultKind, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundLateMemberAccess
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, nameOpt As String, containerTypeOpt As TypeSymbol, receiverOpt As BoundExpression, typeArgumentsOpt As BoundTypeArguments, accessKind As LateBoundAccessKind, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundLateInvocation
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, member As BoundExpression, argumentsOpt As ImmutableArray(Of BoundExpression), argumentNamesOpt As ImmutableArray(Of string), accessKind As LateBoundAccessKind, methodOrPropertyGroupOpt As BoundMethodOrPropertyGroup, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundLateAddressOfOperator
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, binder As Binder, memberAccess As BoundLateMemberAccess, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend MustInherit Partial Class BoundObjectCreationExpressionBase
        ...
        Protected Sub New(kind As BoundKind, syntax as VisualBasicSyntaxNode, initializerOpt As BoundObjectInitializerExpressionBase, type As TypeSymbol, Optional hasErrors As Boolean = False)
            MyBase.New(kind, syntax, type, hasErrors)
    ...
    Friend NotInheritable Partial Class BoundObjectCreationExpression
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, constructorOpt As MethodSymbol, methodGroupOpt As BoundMethodGroup, arguments As ImmutableArray(Of BoundExpression), initializerOpt As BoundObjectInitializerExpressionBase, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundNoPiaObjectCreationExpression
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, guidString As string, initializerOpt As BoundObjectInitializerExpressionBase, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundAnonymousTypeCreationExpression
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, binderOpt As Binder.AnonymousTypeCreationBinder, declarations As ImmutableArray(Of BoundAnonymousTypePropertyAccess), arguments As ImmutableArray(Of BoundExpression), type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundAnonymousTypePropertyAccess
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, binder As Binder.AnonymousTypeCreationBinder, propertyIndex As Integer, type As TypeSymbol, hasErrors As Boolean)
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, binder As Binder.AnonymousTypeCreationBinder, propertyIndex As Integer, type As TypeSymbol)
    ...
    Friend NotInheritable Partial Class BoundAnonymousTypeFieldInitializer
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, binder As Binder.AnonymousTypeFieldInitializerBinder, value As BoundExpression, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend MustInherit Partial Class BoundObjectInitializerExpressionBase
        ...
        Protected Sub New(kind As BoundKind, syntax as VisualBasicSyntaxNode, placeholderOpt As BoundWithLValueExpressionPlaceholder, initializers As ImmutableArray(Of BoundExpression), type As TypeSymbol, Optional hasErrors As Boolean = False)
            MyBase.New(kind, syntax, type, hasErrors)
    ...
    Friend NotInheritable Partial Class BoundObjectInitializerExpression
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, createTemporaryLocalForInitialization As Boolean, binder As Binder, placeholderOpt As BoundWithLValueExpressionPlaceholder, initializers As ImmutableArray(Of BoundExpression), type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundCollectionInitializerExpression
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, placeholderOpt As BoundWithLValueExpressionPlaceholder, initializers As ImmutableArray(Of BoundExpression), type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundNewT
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, initializerOpt As BoundObjectInitializerExpressionBase, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundDelegateCreationExpression
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, receiverOpt As BoundExpression, method As MethodSymbol, relaxationLambdaOpt As BoundLambda, relaxationReceiverPlaceholderOpt As BoundRValuePlaceholder, methodGroupOpt As BoundMethodGroup, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundArrayCreation
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, isParamArrayArgument As Boolean, bounds As ImmutableArray(Of BoundExpression), initializerOpt As BoundArrayInitialization, arrayLiteralOpt As BoundArrayLiteral, arrayLiteralConversion As ConversionKind, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundArrayLiteral
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, hasDominantType As Boolean, numberOfCandidates As Integer, inferredType As ArrayTypeSymbol, bounds As ImmutableArray(Of BoundExpression), initializer As BoundArrayInitialization, binder As Binder, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundArrayInitialization
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, initializers As ImmutableArray(Of BoundExpression), type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundFieldAccess
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, receiverOpt As BoundExpression, fieldSymbol As FieldSymbol, isLValue As Boolean, suppressVirtualCalls As Boolean, constantsInProgressOpt As SymbolsInProgress(Of FieldSymbol), type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundPropertyAccess
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, propertySymbol As PropertySymbol, propertyGroupOpt As BoundPropertyGroup, accessKind As PropertyAccessKind, isWriteable As Boolean, receiverOpt As BoundExpression, arguments As ImmutableArray(Of BoundExpression), type As TypeSymbol, Optional hasErrors As Boolean = False)
        ...
        Public Function Update(propertySymbol As PropertySymbol, propertyGroupOpt As BoundPropertyGroup, accessKind As PropertyAccessKind, isWriteable As Boolean, receiverOpt As BoundExpression, arguments As ImmutableArray(Of BoundExpression), type As TypeSymbol) As BoundPropertyAccess
            If propertySymbol IsNot Me.PropertySymbol OrElse propertyGroupOpt IsNot Me.PropertyGroupOpt OrElse accessKind <> Me.AccessKind OrElse isWriteable <> Me.IsWriteable OrElse receiverOpt IsNot Me.ReceiverOpt OrElse arguments <> Me.Arguments OrElse type IsNot Me.Type Then
                Dim result = New BoundPropertyAccess(Me.Syntax, propertySymbol, propertyGroupOpt, accessKind, isWriteable, receiverOpt, arguments, type, Me.HasErrors)
    ...
    Friend NotInheritable Partial Class BoundEventAccess
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, receiverOpt As BoundExpression, eventSymbol As EventSymbol, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundBlock
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, statementListSyntax As SyntaxList(Of StatementSyntax), locals As ImmutableArray(Of LocalSymbol), statements As ImmutableArray(Of BoundStatement), Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundStateMachineScope
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, fields As ImmutableArray(Of FieldSymbol), statement As BoundStatement, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundLocalDeclaration
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, localSymbol As LocalSymbol, initializerOpt As BoundExpression, initializedByAsNew As Boolean, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundAsNewLocalDeclarations
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, localDeclarations As ImmutableArray(Of BoundLocalDeclaration), initializer As BoundExpression, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundDimStatement
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, localDeclarations As ImmutableArray(Of BoundLocalDeclarationBase), initializerOpt As BoundExpression, Optional hasErrors As Boolean = False)
    ...
    Friend MustInherit Partial Class BoundFieldOrPropertyInitializer
        ...
        Protected Sub New(kind As BoundKind, syntax as VisualBasicSyntaxNode, memberAccessExpressionOpt As BoundExpression, initialValue As BoundExpression, Optional hasErrors As Boolean = False)
            MyBase.New(kind, syntax, hasErrors)
    ...
    Friend NotInheritable Partial Class BoundFieldInitializer
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, initializedFields As ImmutableArray(Of FieldSymbol), memberAccessExpressionOpt As BoundExpression, initialValue As BoundExpression, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundPropertyInitializer
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, initializedProperties As ImmutableArray(Of PropertySymbol), memberAccessExpressionOpt As BoundExpression, initialValue As BoundExpression, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundParameterEqualsValue
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, parameter As ParameterSymbol, value As BoundExpression, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundGlobalStatementInitializer
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, statement As BoundStatement, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundSequence
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, locals As ImmutableArray(Of LocalSymbol), sideEffects As ImmutableArray(Of BoundExpression), valueOpt As BoundExpression, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundIfStatement
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, condition As BoundExpression, consequence As BoundStatement, alternativeOpt As BoundStatement, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundSelectStatement
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, expressionStatement As BoundExpressionStatement, exprPlaceholderOpt As BoundRValuePlaceholder, caseBlocks As ImmutableArray(Of BoundCaseBlock), recommendSwitchTable As Boolean, exitLabel As LabelSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundCaseBlock
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, caseStatement As BoundCaseStatement, body As BoundBlock, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundCaseStatement
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, caseClauses As ImmutableArray(Of BoundCaseClause), conditionOpt As BoundExpression, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundSimpleCaseClause
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, valueOpt As BoundExpression, conditionOpt As BoundExpression, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundRangeCaseClause
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, lowerBoundOpt As BoundExpression, upperBoundOpt As BoundExpression, lowerBoundConditionOpt As BoundExpression, upperBoundConditionOpt As BoundExpression, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundRelationalCaseClause
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, operatorKind As BinaryOperatorKind, operandOpt As BoundExpression, conditionOpt As BoundExpression, Optional hasErrors As Boolean = False)
    ...
    Friend MustInherit Partial Class BoundLoopStatement
        ...
        Protected Sub New(kind As BoundKind, syntax as VisualBasicSyntaxNode, continueLabel As LabelSymbol, exitLabel As LabelSymbol, hasErrors As Boolean)
            MyBase.New(kind, syntax, hasErrors)
        ...
        Protected Sub New(kind As BoundKind, syntax as VisualBasicSyntaxNode, continueLabel As LabelSymbol, exitLabel As LabelSymbol)
            MyBase.New(kind, syntax)
    ...
    Friend NotInheritable Partial Class BoundDoLoopStatement
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, topConditionOpt As BoundExpression, bottomConditionOpt As BoundExpression, topConditionIsUntil As Boolean, bottomConditionIsUntil As Boolean, body As BoundStatement, continueLabel As LabelSymbol, exitLabel As LabelSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundWhileStatement
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, condition As BoundExpression, body As BoundStatement, continueLabel As LabelSymbol, exitLabel As LabelSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundForToUserDefinedOperators
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, leftOperandPlaceholder As BoundRValuePlaceholder, rightOperandPlaceholder As BoundRValuePlaceholder, addition As BoundUserDefinedBinaryOperator, subtraction As BoundUserDefinedBinaryOperator, lessThanOrEqual As BoundExpression, greaterThanOrEqual As BoundExpression, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundForToStatement
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, initialValue As BoundExpression, limitValue As BoundExpression, stepValue As BoundExpression, checked As Boolean, operatorsOpt As BoundForToUserDefinedOperators, declaredOrInferredLocalOpt As LocalSymbol, controlVariable As BoundExpression, body As BoundStatement, nextVariablesOpt As ImmutableArray(Of BoundExpression), continueLabel As LabelSymbol, exitLabel As LabelSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundForEachStatement
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, collection As BoundExpression, enumeratorInfo As ForEachEnumeratorInfo, declaredOrInferredLocalOpt As LocalSymbol, controlVariable As BoundExpression, body As BoundStatement, nextVariablesOpt As ImmutableArray(Of BoundExpression), continueLabel As LabelSymbol, exitLabel As LabelSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundExitStatement
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, label As LabelSymbol, hasErrors As Boolean)
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, label As LabelSymbol)
    ...
    Friend NotInheritable Partial Class BoundTryStatement
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, tryBlock As BoundBlock, catchBlocks As ImmutableArray(Of BoundCatchBlock), finallyBlockOpt As BoundBlock, exitLabelOpt As LabelSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundCatchBlock
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, localOpt As LocalSymbol, exceptionSourceOpt As BoundExpression, errorLineNumberOpt As BoundExpression, exceptionFilterOpt As BoundExpression, body As BoundBlock, isSynthesizedAsyncCatchAll As Boolean, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundLiteral
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, value As ConstantValue, type As TypeSymbol, hasErrors As Boolean)
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, value As ConstantValue, type As TypeSymbol)
    ...
    Friend NotInheritable Partial Class BoundPreviousSubmissionReference
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, sourceType As NamedTypeSymbol, type As TypeSymbol, hasErrors As Boolean)
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, sourceType As NamedTypeSymbol, type As TypeSymbol)
    ...
    Friend NotInheritable Partial Class BoundLocal
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, localSymbol As LocalSymbol, isLValue As Boolean, type As TypeSymbol, hasErrors As Boolean)
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, localSymbol As LocalSymbol, isLValue As Boolean, type As TypeSymbol)
    ...
    Friend NotInheritable Partial Class BoundPseudoVariable
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, localSymbol As LocalSymbol, isLValue As Boolean, emitExpressions As PseudoVariableExpressions, type As TypeSymbol, hasErrors As Boolean)
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, localSymbol As LocalSymbol, isLValue As Boolean, emitExpressions As PseudoVariableExpressions, type As TypeSymbol)
    ...
    Friend NotInheritable Partial Class BoundParameter
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, parameterSymbol As ParameterSymbol, isLValue As Boolean, suppressVirtualCalls As Boolean, type As TypeSymbol, hasErrors As Boolean)
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, parameterSymbol As ParameterSymbol, isLValue As Boolean, suppressVirtualCalls As Boolean, type As TypeSymbol)
    ...
    Friend NotInheritable Partial Class BoundByRefArgumentPlaceholder
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, isOut As Boolean, type As TypeSymbol, hasErrors As Boolean)
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, isOut As Boolean, type As TypeSymbol)
    ...
    Friend NotInheritable Partial Class BoundByRefArgumentWithCopyBack
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, originalArgument As BoundExpression, inConversion As BoundExpression, inPlaceholder As BoundByRefArgumentPlaceholder, outConversion As BoundExpression, outPlaceholder As BoundRValuePlaceholder, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundLateBoundArgumentSupportingAssignmentWithCapture
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, originalArgument As BoundExpression, localSymbol As SynthesizedLocal, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundLabel
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, label As LabelSymbol, type As TypeSymbol, hasErrors As Boolean)
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, label As LabelSymbol, type As TypeSymbol)
    ...
    Friend NotInheritable Partial Class BoundGotoStatement
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, label As LabelSymbol, labelExpressionOpt As BoundLabel, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundStatementList
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, statements As ImmutableArray(Of BoundStatement), Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundConditionalGoto
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, condition As BoundExpression, jumpIfTrue As Boolean, label As LabelSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundWithStatement
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, originalExpression As BoundExpression, body As BoundBlock, binder As WithBlockBinder, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class UnboundLambda
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, binder As Binder, flags As SourceMemberFlags, parameters As ImmutableArray(Of ParameterSymbol), returnType As TypeSymbol, bindingCache As UnboundLambda.UnboundLambdaBindingCache, hasErrors As Boolean)
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, binder As Binder, flags As SourceMemberFlags, parameters As ImmutableArray(Of ParameterSymbol), returnType As TypeSymbol, bindingCache As UnboundLambda.UnboundLambdaBindingCache)
    ...
    Friend NotInheritable Partial Class BoundLambda
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, lambdaSymbol As LambdaSymbol, body As BoundBlock, diagnostics As ImmutableArray(Of Microsoft.CodeAnalysis.Diagnostic), lambdaBinderOpt As LambdaBodyBinder, delegateRelaxation As ConversionKind, methodConversionKind As MethodConversionKind, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundQueryExpression
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, lastOperator As BoundQueryClauseBase, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundToQueryableCollectionConversion
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, conversionCall As BoundCall, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend MustInherit Partial Class BoundQueryClauseBase
        ...
        Protected Sub New(kind As BoundKind, syntax as VisualBasicSyntaxNode, rangeVariables As ImmutableArray(Of RangeVariableSymbol), compoundVariableType As TypeSymbol, binders As ImmutableArray(Of Binder), type As TypeSymbol, hasErrors As Boolean)
            MyBase.New(kind, syntax, type, hasErrors)
        ...
        Protected Sub New(kind As BoundKind, syntax as VisualBasicSyntaxNode, rangeVariables As ImmutableArray(Of RangeVariableSymbol), compoundVariableType As TypeSymbol, binders As ImmutableArray(Of Binder), type As TypeSymbol)
            MyBase.New(kind, syntax, type)
    ...
    Friend NotInheritable Partial Class BoundQueryableSource
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, source As BoundQueryPart, rangeVariableOpt As RangeVariableSymbol, rangeVariables As ImmutableArray(Of RangeVariableSymbol), compoundVariableType As TypeSymbol, binders As ImmutableArray(Of Binder), type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundQueryClause
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, underlyingExpression As BoundExpression, rangeVariables As ImmutableArray(Of RangeVariableSymbol), compoundVariableType As TypeSymbol, binders As ImmutableArray(Of Binder), type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundOrdering
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, underlyingExpression As BoundExpression, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundQueryLambda
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, lambdaSymbol As SynthesizedLambdaSymbol, rangeVariables As ImmutableArray(Of RangeVariableSymbol), expression As BoundExpression, exprIsOperandOfConditionalBranch As Boolean, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundRangeVariableAssignment
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, rangeVariable As RangeVariableSymbol, value As BoundExpression, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class GroupTypeInferenceLambda
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, binder As Binder, parameters As ImmutableArray(Of ParameterSymbol), compilation As VisualBasicCompilation, hasErrors As Boolean)
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, binder As Binder, parameters As ImmutableArray(Of ParameterSymbol), compilation As VisualBasicCompilation)
    ...
    Friend NotInheritable Partial Class BoundGroupAggregation
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, group As BoundExpression, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundRangeVariable
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, rangeVariable As RangeVariableSymbol, type As TypeSymbol, hasErrors As Boolean)
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, rangeVariable As RangeVariableSymbol, type As TypeSymbol)
    ...
    Friend MustInherit Partial Class BoundAddRemoveHandlerStatement
        ...
        Protected Sub New(kind As BoundKind, syntax as VisualBasicSyntaxNode, eventAccess As BoundExpression, handler As BoundExpression, Optional hasErrors As Boolean = False)
            MyBase.New(kind, syntax, hasErrors)
    ...
    Friend NotInheritable Partial Class BoundAddHandlerStatement
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, eventAccess As BoundExpression, handler As BoundExpression, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundRaiseEventStatement
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, eventSymbol As EventSymbol, eventInvocation As BoundExpression, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundUsingStatement
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, resourceList As ImmutableArray(Of BoundLocalDeclarationBase), resourceExpressionOpt As BoundExpression, body As BoundBlock, usingInfo As UsingInfo, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundSyncLockStatement
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, lockExpression As BoundExpression, body As BoundBlock, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundXmlName
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, xmlNamespace As BoundExpression, localName As BoundExpression, objectCreation As BoundExpression, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundXmlNamespace
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, xmlNamespace As BoundExpression, objectCreation As BoundExpression, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundXmlDocument
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, declaration As BoundExpression, childNodes As ImmutableArray(Of BoundExpression), rewriterInfo As BoundXmlContainerRewriterInfo, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundXmlDeclaration
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, version As BoundExpression, encoding As BoundExpression, standalone As BoundExpression, objectCreation As BoundExpression, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundXmlProcessingInstruction
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, target As BoundExpression, data As BoundExpression, objectCreation As BoundExpression, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundXmlComment
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, value As BoundExpression, objectCreation As BoundExpression, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundXmlAttribute
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, name As BoundExpression, value As BoundExpression, matchesImport As Boolean, objectCreation As BoundExpression, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundXmlElement
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, argument As BoundExpression, childNodes As ImmutableArray(Of BoundExpression), rewriterInfo As BoundXmlContainerRewriterInfo, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundXmlMemberAccess
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, memberAccess As BoundExpression, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundXmlCData
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, value As BoundLiteral, objectCreation As BoundExpression, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundResumeStatement
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, resumeKind As ResumeStatementKind, labelOpt As LabelSymbol, labelExpressionOpt As BoundExpression, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundOnErrorStatement
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, onErrorKind As OnErrorStatementKind, labelOpt As LabelSymbol, labelExpressionOpt As BoundExpression, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundUnstructuredExceptionHandlingStatement
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, containsOnError As Boolean, containsResume As Boolean, resumeWithoutLabelOpt As StatementSyntax, trackLineNumber As Boolean, body As BoundBlock, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundUnstructuredExceptionHandlingCatchFilter
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, activeHandlerLocal As BoundLocal, resumeTargetLocal As BoundLocal, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundUnstructuredExceptionOnErrorSwitch
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, value As BoundExpression, jumps As ImmutableArray(Of BoundGotoStatement), Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundUnstructuredExceptionResumeSwitch
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, resumeTargetTemporary As BoundLocal, resumeLabel As BoundLabelStatement, resumeNextLabel As BoundLabelStatement, jumps As ImmutableArray(Of BoundGotoStatement), Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundSpillSequence
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, locals As ImmutableArray(Of LocalSymbol), spillFields As ImmutableArray(Of FieldSymbol), statements As ImmutableArray(Of BoundStatement), valueOpt As BoundExpression, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundMidResult
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, original As BoundExpression, start As BoundExpression, lengthOpt As BoundExpression, source As BoundExpression, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundConditionalAccess
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, receiver As BoundExpression, placeholder As BoundRValuePlaceholder, accessExpression As BoundExpression, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundConditionalAccessReceiverPlaceholder
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, placeholderId As Integer, type As TypeSymbol, hasErrors As Boolean)
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, placeholderId As Integer, type As TypeSymbol)
    ...
    Friend NotInheritable Partial Class BoundLoweredConditionalAccess
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, receiverOrCondition As BoundExpression, captureReceiver As Boolean, placeholderId As Integer, whenNotNull As BoundExpression, whenNullOpt As BoundExpression, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundComplexConditionalAccessReceiver
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, valueTypeReceiver As BoundExpression, referenceTypeReceiver As BoundExpression, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundNameOfOperator
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, argument As BoundExpression, constantValueOpt As ConstantValue, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundTypeAsValueExpression
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, expression As BoundTypeExpression, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundInterpolatedStringExpression
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, contents As ImmutableArray(Of BoundNode), binder As Binder, type As TypeSymbol, Optional hasErrors As Boolean = False)
    ...
    Friend NotInheritable Partial Class BoundInterpolation
        ...
        Public Sub New(syntax As VisualBasicSyntaxNode, expression As BoundExpression, alignmentOpt As BoundExpression, formatStringOpt As BoundLiteral, Optional hasErrors As Boolean = False)
    ...
    Friend MustInherit Partial Class BoundTreeRewriter
        ...
        Public Overrides Function VisitPropertyAccess(node As BoundPropertyAccess) As BoundNode
            ...
            Dim arguments As ImmutableArray(Of BoundExpression) = Me.VisitList(node.Arguments)
            Dim type as TypeSymbol = Me.VisitType(node.Type)
            Return node.Update(node.PropertySymbol, propertyGroupOpt, node.AccessKind, node.IsWriteable, receiverOpt, arguments, type)
        End Function
    ...
    Friend NotInheritable Class BoundTreeDumperNodeProducer
        ...
        Public Overrides Function VisitInitializer(node As BoundInitializer, arg As Object) As TreeDumperNode
            Return New TreeDumperNode("initializer", Nothing, SpecializedCollections.EmptyArray(Of TreeDumperNode)())
        End Function
        ...
        Public Overrides Function VisitStopStatement(node As BoundStopStatement, arg As Object) As TreeDumperNode
            Return New TreeDumperNode("stopStatement", Nothing, SpecializedCollections.EmptyArray(Of TreeDumperNode)())
        End Function

        Public Overrides Function VisitEndStatement(node As BoundEndStatement, arg As Object) As TreeDumperNode
            Return New TreeDumperNode("endStatement", Nothing, SpecializedCollections.EmptyArray(Of TreeDumperNode)())
        End Function
